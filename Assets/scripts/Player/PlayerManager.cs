    ...
    public class PlayerManager : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        public void OnTriggerEnter(Collider other)
        {
            if(this.IsShieldActive)
                Debug.Log("your Shield protected you");
            if (other.tag == triggeringTag && photonView.IsMine && !this.IsShieldActive)
            {
                this.Health -= 0.1f;
            }
        }
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            if (stream.IsWriting)
            {
                ...
                stream.SendNext(this.IsShieldActive);
            }
            else
            {
                ...
                this.IsShieldActive = (bool) stream.ReceiveNext();
            }
        }
